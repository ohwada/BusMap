...
import jp.ohwada.andorid.busmap.util.VolleyUtil;
...
public class BusmapService extends Service {
    ...
    public static final String PACKAGE = "jp.ohwada.andorid.busmap";
    public static final String ACTION = "jp.ohwada.andorid.busmap.BusmapService";
