...
import jp.ohwada.android.busmap.util.DelayUtil;
...
public class MapSettingActivity extends Activity {
    ...
    public void onCreate( Bundle savedInstanceState ) {
        ...
        mSearchView = new SearchView( this, view );
        mSearchView.create();
        mSearchView.setAddressEdit( mSearchView.getGeoName() );
        ...
        mSearcher.setOnChangedListener( 
            ...
            public void onGeocoderFinished( double lat, double lon ) {
                ...
                toast_short(R.string.toast_search_found);
            }
            @Override
    ...
    private void setLocation() {
        String name = mSearchView.getAddressEdit();
        // nothig if no input
        if (( name.length() == 0 )||( name.equals("") )) {
            toast_short( R.string.toast_search_please_name );
            return;
        } 
